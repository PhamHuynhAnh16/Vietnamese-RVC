...
**hoặc:**
```
Nhập vào Command Prompt hoặc Terminal: python main/app/app.py --open
```
- **Để khởi động biểu đồ kiểm tra huấn luyện:**
```
Chạy tệp: tensorboard.bat
```
**hoặc:**
```
Nhập vào Command Prompt hoặc Terminal: python main/app/tensorboard.py
```
