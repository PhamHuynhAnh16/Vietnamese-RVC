...
from main.app.core.ui import gr_info, gr_warning, change_preset_choices, change_effect_preset_choices, change_realtime_preset_choices
...
def load_presets(
    ...
    return [
        ...
        file.get("pitch", pitch), 
        file.get("clean_strength", clean_strength), 
        file.get("index_strength", index_strength), 
        file.get("resample_sr", resample_sr), 
        file.get("filter_radius", filter_radius), 
        file.get("rms_mix_rate", rms_mix_rate), 
        file.get("protect", protect), 
...
def audio_effect_load_presets(
    ...
    return [
        ...
        file.get("chorus_depth", chorus_depth), 
        file.get("chorus_rate_hz", chorus_rate_hz), 
        file.get("chorus_mix", chorus_mix), 
        file.get("chorus_center_delay_ms", chorus_center_delay_ms), 
        file.get("chorus_feedback", chorus_feedback), 
        file.get("distortion_drive_db", distortion_drive_db), 
        file.get("reverb_room_size", reverb_room_size), 
        file.get("reverb_damping", reverb_damping), 
        file.get("reverb_wet_level", reverb_wet_level), 
        file.get("reverb_dry_level", reverb_dry_level), 
        file.get("reverb_width", reverb_width), 
        file.get("reverb_freeze_mode", reverb_freeze_mode), 
        file.get("pitch_shift_semitones", pitch_shift_semitones), 
        file.get("delay_second", delay_second), 
        file.get("delay_feedback", delay_feedback), 
        file.get("delay_mix", delay_mix), 
        file.get("compressor_threshold_db", compressor_threshold_db), 
        file.get("compressor_ratio", compressor_ratio), 
        file.get("compressor_attack_ms", compressor_attack_ms), 
        file.get("compressor_release_ms", compressor_release_ms), 
        file.get("limiter_threshold_db", limiter_threshold_db), 
        file.get("limiter_release_ms", limiter_release_ms), 
        file.get("gain_db", gain_db), 
        file.get("bitcrush_bit_depth", bitcrush_bit_depth), 
        file.get("clipping_threshold_db", clipping_threshold_db), 
        file.get("phaser_rate_hz", phaser_rate_hz), 
        file.get("phaser_depth", phaser_depth), 
        file.get("phaser_centre_frequency_hz", phaser_centre_frequency_hz), 
        file.get("phaser_feedback", phaser_feedback), 
        file.get("phaser_mix", phaser_mix), 
        file.get("bass_boost", bass_boost), 
        file.get("bass_frequency", bass_frequency), 
        file.get("treble_boost", treble_boost), 
        file.get("treble_frequency", treble_frequency), 
        file.get("fade_in", fade_in), 
        file.get("fade_out", fade_out), 
        file.get("chorus_check_box", chorus_check_box), 
        file.get("distortion_checkbox", distortion_checkbox),
        file.get("reverb_check_box", reverb_check_box), 
        file.get("delay_check_box", delay_check_box),
        file.get("compressor_check_box", compressor_check_box), 
        file.get("limiter", limiter),
        file.get("gain_checkbox", gain_checkbox), 
        file.get("bitcrush_checkbox", bitcrush_checkbox),
        file.get("clipping_checkbox", clipping_checkbox), 
        file.get("phaser_check_box", phaser_check_box),
        file.get("bass_or_treble", bass_or_treble), 
        file.get("fade", fade)
    ]
...
def audio_effect_save_presets(
    ...
    for checkbox, data in [
        ...
        (chorus_check_box, {
            ...
            "chorus_center_delay_ms": chorus_center_delay_ms,
...
def save_realtime_config(
    ...
    path = os.path.join(configs["presets_path"], name + ".realtime.json")
    with open(path, "w") as f:
        json.dump(settings, f, indent=4)

    gr_info(translations["export_settings"].format(name=name))
    return change_realtime_preset_choices()
...
def load_realtime_config(
    ...
    return [
        ...
        file.get("chunk_size", chunk_size),
        file.get("pitch", pitch),
        file.get("index_strength", index_strength),
        file.get("predictor_onnx", predictor_onnx),
        file.get("hop_length", hop_length),
        file.get("embedder_mode", embedder_mode),
        file.get("f0_autotune", f0_autotune),
        file.get("proposal_pitch", proposal_pitch),
        file.get("f0_autotune_strength", f0_autotune_strength),
        file.get("proposal_pitch_threshold", proposal_pitch_threshold),
        file.get("rms_mix_rate", rms_mix_rate),
        file.get("protect", protect),
        file.get("filter_radius", filter_radius),
        file.get("silent_threshold", silent_threshold),
        file.get("extra_convert_size", extra_convert_size),
        file.get("cross_fade_overlap_size", cross_fade_overlap_size),
        file.get("vad_sensitivity", vad_sensitivity),
        file.get("vad_frame_ms", vad_frame_ms),
        file.get("clean_audio", clean_audio),
        file.get("clean_strength", clean_strength),
        file.get("post_process", post_process),
        file.get("embedders_mix", embedders_mix),
        file.get("embedders_mix_layers", embedders_mix_layers),
        file.get("embedders_mix_ratio", embedders_mix_ratio),
        ...
        file.get("pitch_shift", pitch_shift),
        file.get("delay", delay),
        file.get("compressor", compressor),
        file.get("limiter", limiter),
        file.get("gain", gain),
        file.get("bitcrush", bitcrush),
        file.get("clipping", clipping),
        file.get("phaser", phaser),
        file.get("chorus_depth", chorus_depth),
        file.get("chorus_rate", chorus_rate),
        file.get("chorus_mix", chorus_mix),
        file.get("chorus_center_delay", chorus_center_delay),
        file.get("chorus_feedback", chorus_feedback),
        file.get("distortion_gain", distortion_gain),
        file.get("reverb_room_size", reverb_room_size),
        file.get("reverb_damping", reverb_damping),
        file.get("reverb_wet_gain", reverb_wet_gain),
        file.get("reverb_dry_gain", reverb_dry_gain),
        file.get("reverb_width", reverb_width),
        file.get("reverb_freeze_mode", reverb_freeze_mode),
        file.get("pitch_shift_semitones", pitch_shift_semitones),
        file.get("delay_seconds", delay_seconds),
        file.get("delay_feedback", delay_feedback),
        file.get("delay_mix", delay_mix),
        file.get("compressor_threshold", compressor_threshold),
        file.get("compressor_ratio", compressor_ratio),
        file.get("compressor_attack", compressor_attack),
        file.get("compressor_release", compressor_release),
        file.get("limiter_threshold", limiter_threshold),
        file.get("limiter_release_time", limiter_release_time),
        file.get("gain_db", gain_db),
        file.get("bitcrush_bit_depth", bitcrush_bit_depth),
        file.get("clipping_threshold", clipping_threshold),
        file.get("phaser_rate_hz", phaser_rate_hz),
        file.get("phaser_depth", phaser_depth),
        file.get("phaser_centre_frequency_hz", phaser_centre_frequency_hz),
        file.get("phaser_feedback", phaser_feedback),
