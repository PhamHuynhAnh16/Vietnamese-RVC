...
def create_reference_tab():
    ...
    with gr.Row():
        create_reference_button = gr.Button(
            translations["create_reference"], 
            variant="primary"
        )
    with gr.Row():
        f0_up_key = gr.Slider(
    ...
    with gr.Row():
        create_reference_info = gr.Textbox(
            label=translations["reference_info"], 
            value="", 
            interactive=False, 
            lines=2
        )
