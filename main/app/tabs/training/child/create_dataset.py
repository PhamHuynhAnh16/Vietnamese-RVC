...
def create_dataset_tab():
    ...
    with gr.Group():
        with gr.Row():
            separate = gr.Checkbox(
                label=translations["separator_tab"], 
                value=False, 
                interactive=True
            )
    ...
    with gr.Row():
        dataset_url = gr.Textbox(
            ...
            info=translations["create_dataset_url"], 
            value="", 
        ...
        output_dataset = gr.Textbox(
            label=translations["output_data"], 
            info=translations["output_data_info"], 
            value="dataset", 
            placeholder="dataset", 
            interactive=True
        )
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            with gr.Row():
                skip_start = gr.Textbox(
                    label=translations["skip_start"], 
                    info=translations["skip_start_info"], 
                    value="", 
                    placeholder="0,...", 
                    interactive=True, 
                    visible=False
                ...
                skip_end = gr.Textbox(
                    label=translations["skip_end"], 
                    info=translations["skip_end_info"], 
                    value="", 
                    placeholder="0,...", 
                    interactive=True, 
                    visible=False
                )
            create_dataset_info = gr.Textbox(
                label=translations["create_dataset_info"], 
                value="", 
                interactive=False, 
                lines=2
            )
